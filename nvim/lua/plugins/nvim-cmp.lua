return {
  ...
  dependencies = {
    ...
    {
      "L3MON4D3/LuaSnip",
      -- Suivre la dernière version release.
      version = "v2.*", -- Remplace <CurrentMajor> par le dernier numéro de version majeure (le premier nombre de la dernière version)
      -- installer jsregexp (optionnel!).
    ...
    "onsails/lspkind.nvim", -- pictogrammes vs-code
  },
  config = function()
    ...
    cmp.setup({
      ...
      snippet = { -- utilise luasnip comme moteur de snippets
